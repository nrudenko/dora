...
public final class TestModelScheme implements IScheme {
    ...
    public static final Column PRIMITIVE_INT_FIELD = new Column("test_model.primitiveIntField", DbType.INT);
    public static final Column INT_FIELD = new Column("test_model.intField", DbType.INT);
    ...
    public static final Column PRIMITIVE_SHORT_FIELD = new Column("test_model.primitiveShortField", DbType.INT);
    public static final Column SHORT_FIELD = new Column("test_model.shortField", DbType.INT);
    ...
    public static final Column PRIMITIVE_BOOL_FIELD = new Column("test_model.primitiveBoolField", DbType.INT);
    public static final Column BOOL_FIELD = new Column("test_model.boolField", DbType.INT);
