...
public abstract class AsyncQueryHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (event) {
                ...
                case EVENT_ARG_INSERT:
                    args.result = resolver.insert(args.uri, args.values[0]);
                    break;
                ...
                case EVENT_ARG_UPDATE:
                    args.result = resolver.update(args.uri, args.values[0], args.selection, args.selectionArgs);
                    break;
    ...
    public final void startInsert(int token, Object cookie, Uri uri, ContentValues initialValues) {
        ...
        args.uri = uri;
        args.cookie = cookie;
        args.values = new ContentValues[]{initialValues};
        msg.obj = args;
    ...
    public final void startUpdate(int token, Object cookie, Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        args.uri = uri;
        args.cookie = cookie;
        args.values = new ContentValues[]{values};
        args.selection = selection;
        args.selectionArgs = selectionArgs;
        msg.obj = args;
